...
- [source](http://github.com/pallets-eco/flask-mail)
- {doc}`changes </changes>`
...
To prevent [header injection](http://www.nyphp.org/PHundamentals/8_Preventing-Email-Header-Injection) attempts to send
